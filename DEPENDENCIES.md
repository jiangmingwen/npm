...
graph LR;
  ...
  npm-->readdir-scoped-modules;
  npm-->rimraf;
  npm-->se-yl-npm-pick-manifest["@se-yl/npm-pick-manifest"];
  npm-->semver;
  npm-->smoke-tests;
  npm-->spawk;
  npm-->ssri;
  ...
  rimraf-->glob;
  se-yl-npm-pick-manifest-->npm-install-checks;
  se-yl-npm-pick-manifest-->npm-normalize-package-bin;
  se-yl-npm-pick-manifest-->npm-package-arg;
  se-yl-npm-pick-manifest-->semver;
  semver-->lru-cache;
